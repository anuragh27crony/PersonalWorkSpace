    ...
    for ch_name in ch_list:
        for bitrate in bit_rates:
            ...
            for hour_dir in hour_dirs_list:
                if "concat_hour_dir" not in hour_dir:
                    print(hour_dir)
                    ...
                    try:
                        if not os.path.isfile(concat_hour_mp4_file):
                            ...
                            final_cmd = r"C:\tools\TtxVVcat\{0}\TtxVVcat.exe -i {1} -o {2} -c:v libx264".format(
                                vvcat_ver,
                                concat_file_path,
                    ...
                    with open(os.path.join(os.getcwd(), "new_readings.txt"), "a+") as file:
