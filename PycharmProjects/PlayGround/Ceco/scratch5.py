...
ch_list = ["tagg_Q_1200", "tagg_F_1600", "tagg_Q_800"]

for ch_name in ch_list:
    print(ch_name)
    detec_ch_util = DetectorUtils(ch_name.lower())

    base_dir = os.path.join("D:\\Dump\\CecoComparision\\4.4-4.5\\udp\\08-nov", ch_name)
    ...
    if "tagg_q_1200" in ch_name.lower():
        ...
        for hour_dir in hour_dirs_list:
            ...
            #
            # for ref_ceco in detec_ch_util.list_files_dir(arb_ref_ceco_dir, "ce"):
            ...
            #     ingest_result = detec_ch_util.FpsUtil.ingest_ref_ceco(arb_ref_ceco_dir, ref_ceco, hour_dir + "0000")
            #
            #     if ingest_result:
            #         candidate_ver = "C4.4"
